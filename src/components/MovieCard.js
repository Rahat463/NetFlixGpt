...
function MovieCard({poster_path,original_title,release_date}) {
  ...
  return (
    <div className=' w-48  bg-gradient-to-t from-black rounded-lg shadow-lg p-2 hover:bg-white hover:translate-y-[-10px] transform transition-transform duration-300 cursor-pointer border-2 border-black ' >
